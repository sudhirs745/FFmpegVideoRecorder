...
public interface ApiService {
    ...
    @GET("audio/getaudiocategory")
    Observable<JsonObject>AudioCategory();

    @Headers("Content-Type: application/json")
    @POST("video/videolisybycategory/{category_id}/{pageNo}")
    Call<JsonObject>getVideoList(@Path("category_id") String category_id, @Path("pageNo") String pageNo);


    @Headers("Content-Type: application/json")
    @POST("video/videolisybycategory/{category_id}/{pageNo}")
    Call<JsonObject>getVideoListData(@Path("category_id") String category_id, @Path("pageNo") String pageNo, @Body JsonObject body);

    @POST("video/videolisybyuser/{user_id}/{pageNo}")
    Call<JsonObject>videolisybyuser(@Path("user_id") String category_id, @Path("pageNo") String pageNo);


    @GET("category/getHashTag/{category_id}")
    Call<JsonObject>getHashtag(@Path("category_id") String category_id);
    ...
    @Headers("Content-Type: application/json")
    @POST("home/homescreenview")
    Call<JsonObject>HomgePageApiCall();
